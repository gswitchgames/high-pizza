    ...
    var t = /* */ function() {
        ...
        (0, _createClass2.default)(t, [ {
                    ...
                    return _regenerator.default.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 2:
                                s = "";
                                s = e instanceof Laya.Scene3D ? e.url : n ? e : t.URLCombine(e, "ls"), null != this._current && s != this._current.url && (this._current.destroy(!0), 
                              ...
                              case 9:
                                ...
                                _context.next = 12;
                                return zs.resource.load(s, zs.ResourceType.Scene3D);
                        ...
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                              ...
                              case 2:
                                ...
                                _context2.next = 6;
                                return zs.resource.load(n, zs.ResourceType.Scene3D);
                        ...
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                              ...
                              case 4:
                                ...
                                _context3.next = 7;
                                return zs.utils.loadScene3D(url);
            ...
            value: function build() {
                ...
                this._staticNode = this._current.getChildByName(t.node_static), this._dynamicNode = this._current.getChildByName(t.node_dynamic), 
                this._preloadNode = this._current.getChildByName(t.node_preload), null == this._staticNode && zs.log.warn("构建世界场景警告！节点Static丢失！"), 
                null == this._dynamicNode && zs.log.warn("构建世界场景警告！节点Dynamic丢失！"), null == this._preloadNode && zs.log.warn("构建世界场景警告！节点Preload丢失！");
                var e = [];
                ...
                t.onBuildWorld && t.onBuildWorld.run(), Laya.StaticBatchManager.combine(this._staticNode), 
