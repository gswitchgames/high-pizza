...
window.zs = window.zs || {}, function(a) {
    ...
    var l = /* */ function() {
        ...
        (0, _createClass2.default)(l, null, [ {
            ...
            key: "registeInfo",
            value: function registeInfo(a, l) {
                ...
                null == this.infos[a] && (this.infos[a] = {}), l && (this.infos[a] = l)) : zs.log.warn("TD SDK不存在，无法注册配置", "Talking Data"));
            }
        }, {
            key: "registeConfig",
            value: function() {
                var _registeConfig = (0, _asyncToGenerator2.default)(/* */ _regenerator.default.mark(function _callee(a) {
                    var _l;
            ...
            key: "justTrack",
            value: function justTrack(a, l, e) {
                this.TDSDK && this.TDSDK.event({
                    id: a,
                    label: l,
                    params: e
                });
            ...
            value: function track(a, l) {
                ...
                var p = {}, o = !1;
                if (null != n.params && n.params.length > 0) if (null == l) n.strict && (zs.log.warn("缺少必要属性，无法上报数据: " + key, "Talking Data"), 
                o = !0); else for (var _a = 0, _e = n.params.length; _a < _e; _a++) {
                    var _e2 = n.params[_a];
                    if (null == l[_e2] && n.strict) {
