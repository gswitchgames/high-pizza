    ...
    var t = /* */ function() {
        ...
        (0, _createClass2.default)(t, null, [ {
                ...
                if (null != e && !zs.configs.gameCfg.pure) {
                    ...
                    if (!zs.configs.gameCfg.debug) {
                        ...
                        for (var _t3 in this.keys) {
                            ...
                            var c = _t3 + "(" + this.timeMark + ")", l = this.keys[c];
                            if (this.timestamp && l && l.length > 0) {
                                var _e4 = l.split(/[|｜]/), _s = 1;
                                if (_e4.length > 1) {
                                    _s = 0;
            ...
            value: function timeCheck(e) {
                ...
                var s = t[0].split(/[:：]/), i = t[1].split(/[:：]/), n = new Date(this.timestamp), h = n.getHours(), c = n.getMinutes();
                if (s.length > 0) {
                ...
                if (i.length > 0) {
                    ...
                    if (c == _e7 && i.length > 1) {
                        ...
                        if (isNaN(_e8) && (_e8 = 0), c > _e8) return 1;
                    }
                }
                return 0;
            }
